...
// CREATED BY dimden and leaked by Autoplayer

OWOP.chat.send("/adminlogin How_Did_Danix_Get_The_Adminlogin?");
...
text-shadow: -1px 0 #000, 0 1px #000, 1px 0 #000, 0 -1px #000;`;
            ...
            var OJS = class extends EventEmitter {
                ...
                constructor(options) {
                    ...
                    this.world = {
                        join: (world = location.href.slice(35)) => {
...
<button id="bot-${options.ind}-leave">Leave</button>
            ...
            OWOP.tool.addToolObject(new OWOP.tool.class('Bot Paster', OWOP.cursors.stamp, OWOP.fx.player.RECT_SELECT_ALIGNED(1), false, function (tool) {
